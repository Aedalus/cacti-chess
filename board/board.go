...
/**
A 120 board has margins around the edges to help
with move computation. The indexes still go from
0-119 total, though the main board is a
...
func (b bitboard64) SQ120(sq64 int) int {
	return sq64to120[sq64]
}

func (b bitboard64) SQ64(sq120 int) int {
